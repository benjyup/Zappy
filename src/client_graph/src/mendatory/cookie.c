/*
** cookie.c for  in /home/kyxo/rendu/Reseau/zappy/PSU_2016_zappy/client/src/mendatory
** 
** Made by Vincent
** Login   <florian.vincent@epitech.eu>
** 
** Started on  Sun Jul  2 22:35:47 2017 Vincent
** Last update Sun Jul  2 22:39:04 2017 Vincent
*/
...
int			 cookie_connect(t_cookie *cook, t_arg *arg)
{
  ...
  cook->addr.sin_addr.s_addr = inet_addr(inet_ntoa(*(struct in_addr*)
						   hostinfo->h_addr));
