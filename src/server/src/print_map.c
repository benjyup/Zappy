...
** Last update Mon Jun 26 14:39:05 2017 vincent.mesquita@epitech.eu
*/
...
void		print_fd(t_env *env, t_pos pos)
{
  int			cpt;
...
void		choose_print(t_env *env, t_pos pos)
{
...
void		print_simple_map(t_env *env)
{
  t_pos			pos;
